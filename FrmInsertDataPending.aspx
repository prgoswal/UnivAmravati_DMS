<%@ Page Title="" Language="C#" MasterPageFile="~/SubMaster.master" AutoEventWireup="true" CodeFile="FrmInsertDataPending.aspx.cs" Inherits="FrmInsertDataPending" %>
                                        ...
                                        <asp:Panel runat="server" ID="pnlcounter" Visible="true">
                                            <div class="table table-responsive m-0">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        <asp:GridView ID="grdEntry" CssClass="table text-center table-hover m0" runat="server" AutoGenerateColumns="False" OnRowDeleting="grdEntry_RowDeleting">
